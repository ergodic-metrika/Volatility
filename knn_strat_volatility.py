...
#Where pt is the current closing price of spot and pt+1 is the 1-day forward closing pricing of spot
#If tomorrow's price > today's price, then buy; else, sell.
y = np.where(df['Close'].shift(-1)>0.995*df['Close'],1,-1) 
y
